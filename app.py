...
if uploaded_file:
    ...
    feature_columns = data[["bath", "balcony", "bhk", "price_per_sqft", "new_total_sqft"]]  # st.sidebar.multiselect("Select Feature Columns (Predictors)", [col for col in data.columns if col != target_column])
